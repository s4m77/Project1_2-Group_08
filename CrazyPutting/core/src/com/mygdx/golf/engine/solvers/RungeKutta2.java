...
public class RungeKutta2 implements Solver {
    ...
    public Vector2 solvePos(Vector2 position, Vector2 velocity) {
        ...
        //calculate Velocity2
        Vector2 updatedPosition= new Vector2(position.x + 2/3 * engine.getDt(), position.y + 2/3 * engine.getDt());
        Vector2 updatedVelocity= new Vector2(velocity.x + 2/3 * ki1.x, velocity.y + 2/3 * ki1.y);
        ...
        return new Vector2(position.x + 1/4 * ki1.x + 3/4 * ki2.x, position.y + 1/4 * ki1.y + 3/4 * ki2.y);  
    }
    ...
    public Vector2 solveVel(Vector2 position, Vector2 velocity) {
        ...
        return new Vector2(velocity.x + 1/4 * ki1.x + 3/4 * ki2.x, velocity.y + 1/4 * ki1.y + 3/4 * ki2.y); 
