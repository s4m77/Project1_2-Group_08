...
public class JsonFileManager {
    ...
    public static void writeMapToJson(int[][] map, String fileName) {
        try {
            // create a writer
            BufferedWriter writer = Files.newBufferedWriter(Paths.get("core/src/com/mygdx/golf/jsonMaps/" + fileName + ".json"));
    ...
    public static int[][] readMapFromJson(String fileName) {
        try {
            // create a reader
            Reader reader = Files.newBufferedReader(Paths.get("core/src/com/mygdx/golf/jsonMaps/" + fileName + ".json"));
    ...
    public static String[] getAllMapNames() {
        File folder = new File("core/src/com/mygdx/golf/jsonMaps/");
